import 'package:SHU_QI/model/chapter.dart';
...
class _ReaderMenuState extends State<ReaderMenu>
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Container(width: 44, child: Image.asset('img/read_icon_voice.png')),
            Container(width: 44, child: Image.asset('img/read_icon_more.png')),
          ],
        ),
      ),
    );
  ...
  buildProgressTipView() {
    ...
    return Container(
      decoration: BoxDecoration(
          color: Color(0xff00cbbd), borderRadius: BorderRadius.circular(3)),
  ...
  buildBottomView() {
    return Positioned(
      bottom: -(Screen.bottomSafeHeight + 100) * (1 - animation.value),
      left: 0,
      right: 0,
      child: Column(
        children: [
      ...
      child: Column(
        children: [
          ...
          Text(
            title,
            style:
                TextStyle(fontSize: fixedFontSize(12), color: SQColor.darkGray),
          ),
        ],
      ),
    );
